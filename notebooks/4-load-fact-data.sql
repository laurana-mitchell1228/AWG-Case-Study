...
INSERT OVERWRITE case_study.pubz.fact_daily_sales (
...
FROM case_study.cnfz.clean_store_sales_updated s
JOIN case_study.pubz.dim_store ds ON s.store_id = ds.store_id
JOIN case_study.pubz.dim_product dp ON s.sku = dp.sku
